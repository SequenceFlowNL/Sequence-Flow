...
const blogs = [
  ...
  },
  {
    id: 2,
    title: 'Product tour',
    subtitle: 'A visual overview of everything you can do inside SequenceFlow.',
    time: '25 Hours',
    readTime: '25 Hours',
    tag: 'Crypto',
    image: blog2,
          ...
          <div className="col-span-12 sm:col-span-6 lg:col-span-4">
            <article className="dark:bg-background-5 border-stroke-4 dark:border-stroke-5 mx-auto max-w-[500px] overflow-hidden rounded-[20px] border bg-white md:mx-0 md:max-w-full">
              ...
              <div className="space-y-6 p-6">
                ...
                <div>
                  <LinkButton href="#" btnClass="btn-md-v2 btn-v2-white group-hover/btn-v2:btn-secondary-v2">
                    Read more
                  </LinkButton>
                </div>
              </div>
