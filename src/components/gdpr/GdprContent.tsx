...
const GdprContent = () => {
  ...
  const dataPurposes: ListItem[] = [
    { id: 'account-management', text: 'To create and manage your SequenceFlow account' },
        ...
        <div className="space-y-[70px]">
          ...
          <RevealAnimation delay={0.3}>
            <div className="space-y-3">
              <h2>SequenceFlow and the general data protection regulation (GDPR)</h2>
              <p>
                ...
                <br />
                <br />
                This page explains how SequenceFlow implements GDPR principles and ensures that your data is handled
          ...
          <RevealAnimation delay={0.4}>
            <div className="space-y-6">
              <div className="space-y-3">
                ...
                <p>
                  At SequenceFlow, we are fully committed to respecting your privacy. This page provides a clear overview
                  of:
                </p>
              </div>
          ...
          <RevealAnimation delay={0.5}>
            <div className="space-y-3">
              ...
              <p>
                ...
                SequenceFlow) must be transparent about what data they collect, how they use it, and how they share it — and
                ...
                residents, including SequenceFlow.
              </p>
            </div>
          </RevealAnimation>
          {/* How SequenceFlow Implements GDPR */}
          <RevealAnimation delay={0.3}>
            <div className="space-y-3">
              <h3 className="text-heading-4">How SequenceFlow Implements GDPR</h3>
              <p>
                SequenceFlow has always prioritized user data privacy, even before GDPR came into effect. Our core practices
