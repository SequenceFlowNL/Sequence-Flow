      ...
      <div className="main-container">
        <div className="mb-11 text-center lg:mx-auto lg:mb-9 lg:max-w-[730px]">
          <RevealAnimation delay={0.1}>
            <span className="badge badge-gray-light-v2 mb-5">Onze Diensten</span>
          </RevealAnimation>
          <RevealAnimation delay={0.2}>
            <h2 className="mb-1 md:mb-3">Ontdek wat SequenceFlow voor uw bedrijf kan betekenen.</h2>
          </RevealAnimation>
          <RevealAnimation delay={0.3}>
            <p className="lg:mx-auto lg:max-w-[530px]">
              Onze kracht ligt in het vertalen van complexe business-logica naar robuuste, geautomatiseerde workflows
              die direct resultaat leveren.
            </p>
          </RevealAnimation>
        </div>
        {/* services cards */}
