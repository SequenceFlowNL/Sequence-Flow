        ...
        <div className="bg-secondary mx-auto max-w-[1880px] rounded-3xl px-5 lg:py-24 xl:rounded-4xl xl:py-28">
          <div className="mx-auto max-w-[1400px] py-16 lg:py-20 xl:py-30">
            <h2
              ...
              Wij elimineren operationele frictie en verhogen de output van onze klanten zonder dat zij extra personeel
              hoeven aan te nemen. Flow-as-a-Service is onze kracht.
            </h2>
          </div>
        </div>
      </RevealAnimation>
