        ...
        <div className="mb-[70px] space-y-14 text-center">
          <div className="space-y-3">
            <RevealAnimation delay={0.3}>
              <h2>Need help with SequenceFlow?</h2>
            </RevealAnimation>
            <RevealAnimation delay={0.4}>
              <p>
                Welcome to the SequenceFlow Support Center! We&apos;re ready to assist you if you have an issue or a
                question.
              </p>
            </RevealAnimation>
          </div>
          <RevealAnimation delay={0.5}>
            <div>
              <LinkButton href="/contact-us" btnClass="btn-xl-v2 btn-primary-v2 group-hover/btn-v2:btn-secondary-v2">
                Get help
              </LinkButton>
            </div>
          </RevealAnimation>
